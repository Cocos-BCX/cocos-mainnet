...
FC_REFLECT( graphene::chain::create_nh_asset_order_operation, (fee)(seller)(otcaccount)(pending_orders_fee)(nh_asset)(memo)(price)(expiration) )

FC_REFLECT( graphene::chain::cancel_nh_asset_order_operation::fee_parameters_type, (fee) )

FC_REFLECT( graphene::chain::cancel_nh_asset_order_operation, (fee)(order)(fee_paying_account)(extensions) )

FC_REFLECT( graphene::chain::fill_nh_asset_order_operation::fee_parameters_type, (fee) )

FC_REFLECT( graphene::chain::fill_nh_asset_order_operation, (fee)(order)(fee_paying_account)(seller)(nh_asset)(price_amount)
          (price_asset_id)(price_asset_symbol)(extensions) )
